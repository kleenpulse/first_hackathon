...
export const Rewards = () => {
	return (
		<div className="flex justify-center w-full items-center py-20 relative z-10 h-full flex-1 ">
			<div className="flex justify-center w-full items-center max-container sm:px-12 h-full ">
				<div className="flex justify-between w-full items-center h-full flex-1 ">
					<div className="flex w-full p-6 relative items-center justify-center">
						<Image
